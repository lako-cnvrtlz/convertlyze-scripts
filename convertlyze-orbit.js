...
(function () {
  ...
  function initDesktopStepper(wrap) {
    ...
    s.textContent =
      "#cvly-orbit-wrap{width:480px;height:auto!important;min-height:0!important;padding:0!important;margin:0!important;font-family:system-ui,-apple-system,sans-serif;user-select:none;box-sizing:border-box;}" +
      ".cvly-ds-inner{background:#0d1117;border-radius:20px;border:1px solid rgba(79,209,197,0.15);overflow:hidden;width:480px;box-sizing:border-box;}" +
      ".cvly-ds-body{display:flex;align-items:stretch;gap:0;padding:24px 24px 20px;min-height:210px;width:480px;box-sizing:border-box;}" +
