...
(function () {
    ...
    return (
      '<div class="cvly-lp-frame" id="' + prefix + 'frame">' +
        '<div class="cvly-lp-mock" style="width:' + w + 'px;height:' + h + 'px;">' +
          ...
          '</div>' +
          '<div class="cvly-lp-body" style="padding-bottom:8px;">' +
            ...
            '</div>' +
            '<div class="cvly-lp-sec" id="' + prefix + 'cta" style="height:' + ctaH + 'px;background:#0a0f1a;display:flex;align-items:center;justify-content:center;margin-bottom:6px;">' +
  ...
  function initOrbit(wrap) {
    ...
    wrap.innerHTML =
      '<div id="cvly-orbit-scaler">' +
        ...
        '</div>' +
      '</div>' +
      '<div id="cvly-panel-wrap"><div id="cvly-panel"></div></div>';
  ...
  function initStepper(wrap) {
    ...
    s.textContent=
      ...
      ".cvly-stepper-top{padding:28px 24px;display:flex;gap:20px;align-items:center;height:280px;}" +
      ".cvly-stepper-info{flex:1;min-width:0;width:100%;display:flex;flex-direction:column;justify-content:center;align-items:flex-start;}" +
      ".cvly-step-counter{font-size:10px;color:#4a5568;letter-spacing:.5px;margin-bottom:12px;}" +
      ".cvly-step-head{display:flex;flex-direction:column;align-items:flex-start;gap:6px;margin-bottom:10px;}" +
      ".cvly-icon-wrap{width:38px;height:38px;border-radius:10px;background:#161b27;border:1.5px solid var(--sc);display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:border-color .3s;color:var(--sc);}" +
      ".cvly-step-label{font-size:15px;font-weight:700;color:#e2e8f0;}" +
      ".cvly-step-finding{font-size:13px;font-weight:600;color:#e2e8f0;margin-bottom:6px;line-height:1.4;text-align:left;width:100%;}" +
      ".cvly-step-tip{font-size:11px;color:#94a3b8;line-height:1.5;overflow:hidden;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;text-align:left;width:100%;}" +
    ...
    function render() {
      ...
      document.getElementById("cvly-step-info").innerHTML=
        ...
        '<div style="width:38px;height:38px;border-radius:10px;background:#161b27;border:1.5px solid '+cat.sevCol+';display:flex;align-items:center;justify-content:center;margin-bottom:8px;color:'+cat.sevCol+';">'+ICONS[cat.label]+'</div>'+
        ...
        '<div style="font-size:11px;color:#94a3b8;line-height:1.5;overflow:hidden;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;width:100%;">&#8594; '+cat.tip+'</div>';
